...
const migrationName = "20260813190000_person_source_provenance"

// Idempotent production apply. Mirrors
// prisma/migrations/20260813190000_person_source_provenance. Purely
...
async function main() {
  ...
  try {
    await addColumnIfMissing(client, "Person", "source", "TEXT")
