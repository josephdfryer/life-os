...
final class LocationConnector: NSObject, @preconcurrency CLLocationManagerDelegate {
    ...
    func start() { manager.requestAlwaysAuthorization(); if CLLocationManager.significantLocationChangeMonitoringAvailable() { manager.startMonitoringSignificantLocationChanges() }; manager.startMonitoringVisits() }
