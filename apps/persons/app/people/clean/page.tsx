  ...
  return (
    <div style={{ maxWidth: "960px", margin: "0 auto", padding: "32px 24px" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", marginBottom: "22px" }}>
        ...
        <Link href="/people/merge" style={{ padding: "9px 16px", background: "transparent", color: "var(--ink-3)", border: "1px solid var(--border)", borderRadius: "7px", fontFamily: "inherit", fontSize: "12px", textDecoration: "none" }}>
          ⇄ Dedupe
        </Link>
      </div>
              ...
              <div style={{ display: "flex", gap: "12px", minWidth: 0, alignItems: "center" }}>
                ...
                <div style={{ minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "baseline", gap: "8px", flexWrap: "wrap" }}>
                    <Link href={`/people/${person.id}`} style={{ color: "var(--ink)", fontWeight: 600, fontSize: "13px", textDecoration: "none" }}>
                      {displayName(person)}
                    </Link>
