...
export const config = {
  ...
  matcher: [
    "/((?!api/auth|login|privacy|terms|admin/connections/oura/callback|admin/connections/google/gmail/callback|admin/connections/google/calendar/callback|connections/oura/callback|device/authorize|_next/static|_next/image|favicon.ico).*)",
  ],
}
